...
# various parameters from our program. Given the hash below, print out the
...
munsters.each do |name, values_hash|
  puts "#{name} is a #{values_hash["age"]}-year-old #{values_hash["gender"]}."
end
