...
# 3333, 103103 and 7676 are all double numbers.  444, 334433, and 107 are
# not.  Write a method which returns 2 times the number provided as an
# argument, unless the argument is a double number; double numbers should
# be returned as-is.
# --------------------------------------------------------------------------- #
